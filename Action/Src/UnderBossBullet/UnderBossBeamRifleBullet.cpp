#include "UnderBossBeamRifleBullet.h"
...
UnderBossBeamRifleBullet::UnderBossBeamRifleBullet(IWorld* world, const GSvector3& position, const GSvector3& velocity, int Damage) {

	world_ = world;

	tag_ = "EnemyBulletTag";

	name_ = "UnderBossBeamRifleBullet";
...
void UnderBossBeamRifleBullet::update(float delta_time) {
...
void UnderBossBeamRifleBullet::react(Actor& other) {
